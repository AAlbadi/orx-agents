...
def generate_call_demo_script(profile: Dict[str, Any], scenario_id: Optional[str] = None) -> Dict[str, Any]:
    ...
    TRADE_DEMO_DATA = {
        "hvac": {
            ...
            "booking_confirm_line": f"You're all set, Sarah! I have our technician locked in for today between two and five PM at 419 Maple Drive. They'll text fifteen minutes before arriving. I just sent confirmation to your cell!",
            ...
            "daytime_agent_service": f"Oh no, dealing with AC trouble on a warm day is such a headache! We can definitely help you out with that. Are you home today so we can get a technician out to take a look?",
            ...
            "daytime_agent_area_a": f"Oh absolutely, Maple Drive is right in our area! We actually have a technician open this afternoon. Can I grab your name and best cell number to get you booked?",
            ...
            "ah_booking_line": f"You're all set, Marcus! I've reserved our priority eight to ten AM slot for you tomorrow at 1042 Bayside Avenue, and texted confirmation to your phone.",
            ...
            "ah_agent_triage": "Oh no, eighty-two degrees with kids in the house is rough! Don't worry, we'll take care of you. Are you noticing any burning smell or strange noises from the unit?",
            ...
            "ah_agent_address_a": f"Oh, Bayside Avenue in {city_disp} is no problem at all — we cover that area all the time! Can I grab your name and cell number for the confirmation?",
            "ah_cust_info_turn": "Marcus Vance, cell is 415-555-0834. And hey — what if the whole unit needs replacing?",
            "ah_agent_scope_a": "We carry equipment for both repairs and replacements on the truck, so you're covered either way without having to call around.",
        },
        "plumbing": {
            ...
            "booking_confirm_line": f"You're all set, David! I have our licensed plumber locked in for today between two and five PM at 724 Oak Crest Lane. They'll text fifteen minutes before arriving. I just sent confirmation to your cell!",
            ...
            "daytime_agent_service": f"Oh no, water leaks are so stressful! We can definitely help. Is the water just dripping slowly into the drain pan, or is it actively spreading onto the floor?",
            ...
            "daytime_agent_area_a": f"Oh absolutely, Oak Crest Lane is right in our area! We have a licensed plumber available this afternoon. Can I get your name and best mobile number?",
        ...
        "electrical": {
            ...
            "booking_confirm_line": f"You're all set, Robert! I've scheduled our certified electrician for today between two and five PM at 812 Highland View. They'll text fifteen minutes before arriving. I just sent confirmation to your mobile!",
            ...
            "daytime_agent_service": f"Oh wow, losing power to the kitchen is such a hassle! We can definitely get a licensed electrician out today. Do you notice any buzzing, burning smell, or heat from the panel?",
            ...
            "daytime_agent_area_a": f"Yes, Highland View is right in our primary service area! We have an electrician available this afternoon. Can I grab your name and best phone number?",
        ...
        "roofing": {
            ...
            "booking_confirm_line": f"You're all set, Tom! I've scheduled our senior roofing estimator for today between one and four PM at 518 Pine Valley Road for your free inspection. They'll text fifteen minutes before arriving. I just sent confirmation to your mobile!",
            ...
            "daytime_agent_service": f"Oh no, dealing with storm damage and ceiling leaks is so stressful! We can definitely get an inspector out today to protect your home before the next rain. Are you home this afternoon?",
            ...
            "daytime_agent_area_a": f"Oh yes, Pine Valley Road is right in our coverage area! We have an inspector available between one and four today. Can I get your name and cell number?",
            ...
            "daytime_agent_scope_a": f"Yes, we work directly with insurance adjusters on storm claims and handle everything from spot repairs to full replacements" + (f" including {custom_services_str}" if custom_services_str else "") + ".",
            ...
            "ah_booking_line": f"You're all set, Marcus! I've locked in our emergency storm crew for first light tomorrow at seven-thirty AM at 1042 Bayside Avenue to get tarps up and stop the water. Confirmation is on your phone.",
            ...
            "ah_agent_solution": f"Keep that bucket in place, and if the ceiling starts sagging, poke a tiny pinhole in the center to relieve pressure. I'm locking you in for our very first seven-thirty AM emergency slot so our crew can tarp the roof at daylight. {pricing_spoken}",
            "ah_cust_address_q": "Thank you so much. I'm at 1042 Bayside Avenue — can you definitely get someone out at first light?",
            "ah_agent_address_a": f"Yes, Bayside Avenue in {city_disp} will be our first emergency stop! Can I get your full name and mobile number to alert the storm crew?",
        ...
        "dental_medical": {
            ...
            "booking_confirm_line": f"You're all set, Emily! I've reserved our emergency doctor chair for you today at one-thirty PM at {biz_name}. Please arrive ten minutes early. I just texted your confirmation and digital intake link!",
            ...
            "daytime_agent_service": f"Oh no, I'm so sorry you're in pain — severe toothaches are completely miserable! We always keep same-day emergency chairs open. Are you noticing any facial swelling?",
            ...
            "daytime_agent_area_a": f"Our clinic is right here in {city_disp} with easy parking. We have an emergency chair open at one-thirty today. Can I get your full name and cell number to get you checked in?",
        ...
        "auto": {
            ...
            "daytime_agent_service": f"Oh wow, severe shaking and a flashing engine light is definitely scary to drive with! We can get it right onto the lift today. Can you safely nurse the car over to our shop?",
            ...
            "daytime_agent_area_a": f"Our shop is located right in {city_disp} with quick drop-off. One o'clock is perfect! May I grab your name and cell number to reserve your bay?",
        ...
        "legal": {
            ...
            "daytime_agent_service": f"I am so sorry to hear about your accident — dealing with aggressive insurance calls while recovering is exhausting! You definitely shouldn't sign anything yet. Are you receiving medical care for your injuries?",
            ...
            "daytime_agent_area_a": f"Yes, we handle consultations by phone, video, or in-person right here in {city_disp}. We have an opening today at two PM with a senior attorney. Can I get your full name and cell number?",
        ...
        "restaurant": {
            ...
            "daytime_agent_service": f"Happy 40th anniversary to your parents — that is such an incredible milestone! We would love to host your celebration. We have a wonderful table this Friday at seven-fifteen PM. Would that work?",
        ...
        "realestate": {
            ...
            "daytime_agent_service": f"Hello! Yes, that craftsman on Highland Park Boulevard is actively on the market — it has high ceilings and an amazing kitchen. We can definitely set up a private walkthrough this afternoon. Are you pre-approved or purchasing cash?",
            ...
            "daytime_agent_area_a": f"Yes, absolutely! {city_disp.title()} is our primary market and our agents are out there daily. We have a private showing open at four-thirty PM. May I get your name and cell number?",
        ...
        "salon_spa": {
            ...
            "daytime_agent_service": f"Hello! We would love to have you looking gorgeous for the wedding! We have an opening with our master colorist this Thursday at two PM. How long is your hair right now?",
            ...
            "daytime_agent_area_a": f"Our boutique salon is right in {city_disp} with free parking right out front. Can I grab your name and cell number to hold that Thursday two PM chair?",
        ...
        "general": {
            ...
            "booking_confirm_line": f"You're all set, Mark! I've scheduled our commercial service specialist for today between one and four PM at 419 Commercial Boulevard. They'll text fifteen minutes before arriving. I just sent confirmation to your cell!",
            ...
            "daytime_agent_service": f"Yes, absolutely — we can get a specialist out to inspect your facility today and provide a clear written estimate. What specific equipment is acting up?",
            ...
            "daytime_agent_area_a": f"Yes, Commercial Boulevard is right in our service area! We have an opening today between one and four PM. May I get your name and best cell number?",
        ...
        "after_hours_test": {
            ...
            "turns": [
                ...
                },
                {
                    ...
                    "name": "Marcus (Caller)",
                    "voice": customer_voice,
                    "text": "Thank you so much. It's such a relief knowing someone is actually coming in the morning."
                },
                {
                    "speaker": "agent",
                    "name": f"{persona_name} (Receptionist)",
