...
def generate_call_demo_script(profile: Dict[str, Any], scenario_id: Optional[str] = None) -> Dict[str, Any]:
    ...
    TRADE_DEMO_DATA = {
        "hvac": {
            ...
            "booking_confirm_line": f"You're all set, Sarah! I've locked you in for today between two and five PM at 419 Maple Drive. Our technician will text you fifteen minutes before arrival so you're not waiting. I just sent a confirmation text to your cell — anything else I can help with?",
            "sms_body_routine": f"Hi Sarah! You're confirmed with {biz_name} for today, 2–5 PM at 419 Maple Drive. Our technician will text 15 min before arrival. Reply to this text anytime with questions.",
            ...
            "daytime_agent_service": f"Absolutely, that's right in our wheelhouse. If your AC is running continuously and blowing warm air, it's typically a low refrigerant charge, a frozen evaporator coil, or a failing capacitor — completely fixable. Are you home today so we can get a technician out to check it?",
            "daytime_cust_price_q": "Yeah I'm home. Quick question though — what do you charge just to come out and look? Because last company I called wanted ninety-five dollars just to show up.",
            "daytime_agent_price_a": f"I completely understand — {pricing_spoken} The diagnostic covers a full system inspection — we check refrigerant levels, electrical connections, filters, and run the unit through its cycle, so by the time they're done you know exactly what's wrong and what it'll cost to fix. No surprise bills.",
            ...
            "daytime_agent_area_a": f"Yes, Maple Drive in {city_disp} is absolutely in our core coverage zone — we have technicians in {city_disp} every day. We actually have an opening this afternoon. Can I get your name and a good cell number so I can lock that in for you?",
            "daytime_cust_name_turn": "Sure — Sarah Thompson, and my cell is 713-555-0184. One more thing — if it turns out my unit is totally shot, do you guys also do full replacements or just repairs?",
            "daytime_agent_scope_a": f"We handle everything in-house — repairs, full system replacements" + (f", {custom_services_str}" if custom_services_str else ", new installs and duct work") + ", and smart thermostats. So whether it's a quick fix or a new system, your tech will walk you through every option with written pricing right there on-site, zero pressure.",
            ...
            "ah_booking_line": f"Perfect — I've reserved our first-priority slot tomorrow morning, eight to ten AM, at 1042 Bayside Avenue for you. Our technician will reach out before heading out. I just sent confirmation to your cell.",
            ...
            "ah_agent_triage": "I'm really sorry to hear that — eighty-two degrees with kids is rough. First, are you noticing anything that could be an emergency? Any burning smell, strange sounds, or anything like that?",
            ...
            "ah_agent_solution": f"Got it — since it's not an active emergency hazard, here's what I can do. I'll reserve our very first priority slot tomorrow morning, eight to ten AM, so your tech is literally one of the first out the door. {pricing_spoken} And I'll alert our on-call team right now so they know about you first thing.",
            ...
            "ah_agent_address_a": f"Bayside Avenue in {city_disp} is no problem at all — we cover that area all the time. Can I get your name and best cell number for the morning confirmation text?",
            "ah_cust_info_turn": "Marcus Vance, cell is 415-555-0834. And hey — what if the whole unit needs replacing?",
            "ah_agent_scope_a": "We carry equipment for both repairs and replacements, so you won't need to make a second call no matter what they find.",
        },
        "plumbing": {
            ...
            "booking_confirm_line": f"You're all set, David! I've locked in our licensed plumber for today between two and five PM at 724 Oak Crest Lane. Our plumber will text you fifteen minutes before arrival with live tracking. I just sent confirmation to your cell — anything else I can help with?",
            ...
            "daytime_agent_service": f"Yes, absolutely — we can definitely take care of that for you. An active water heater leak needs prompt attention before it causes water damage. Is the water pooling slowly into the drain pan, or is it gushing out across the floor?",
            ...
            "daytime_agent_price_a": f"I completely understand — {pricing_spoken} Our diagnostic covers a full system inspection — we test the pressure relief valve, thermostat, burner assembly, and check the tank lining for cracks so you get an exact written quote before anything is touched.",
            "daytime_cust_area_q": f"That's fair. I'm at 724 Oak Crest Lane in {city_disp} — do you have plumbers that cover {city_disp} today?",
            "daytime_agent_area_a": f"Yes, Oak Crest Lane in {city_disp} is well within our primary service zone. We actually have a licensed plumber in {city_disp} this afternoon. Can I get your name and best mobile number to get that booked?",
            "daytime_cust_name_turn": "David Miller, cell is 512-555-0198. Quick question — if the tank is cracked and rusted out, do you guys replace the whole water heater or will I have to find another company?",
            "daytime_agent_scope_a": f"Our plumbing trucks are fully stocked, and we do " + (f"{custom_services_str}, and " if custom_services_str else "") + "complete same-day water heater replacements — both traditional tank and tankless models. You will have everything taken care of today without needing to call anyone else.",
            "ah_slot": "Tomorrow 8:00 AM – 10:00 AM Priority Window",
            "ah_status": "After-Hours Urgent Triage — Plumber Alerted",
            "owner_alert_ah_title": "🌙 After-Hours Plumbing Alert",
            "ah_booking_line": f"Perfect — I've reserved our first-priority slot tomorrow morning, eight to ten AM, at 1042 Bayside Avenue. Our master plumber will have the motorized auger and inspection camera ready. I just sent confirmation to your phone.",
            ...
            "ah_agent_triage": "I hear you — a late-night kitchen backup is awful. First, is water overflowing onto your cabinets or floor, or is it contained inside the sink bowl?",
            ...
            "ah_agent_solution": f"Good — keep all taps off for tonight so nothing overflows. Since it's contained, I'll reserve our very first priority slot tomorrow morning, eight to ten AM. Our master plumber will have the motorized auger ready. {pricing_spoken}",
            "ah_cust_address_q": "Okay that's a relief. I'm at 1042 Bayside Avenue — will they definitely make it out first thing?",
            "ah_agent_address_a": f"Yes, 1042 Bayside Avenue in {city_disp} will be our plumber's first stop. Can I get your name and cell number so I can dispatch the priority alert right now?",
            "ah_cust_info_turn": "Marcus Vance, cell is 415-555-0834. And you guys do full drain camera inspections too right?",
            "ah_agent_scope_a": "Yes, we have high-definition sewer cameras on the truck to inspect the main line all the way to the city hookup.",
        },
        "electrical": {
            ...
            "booking_confirm_line": f"You're all set, Robert! I've scheduled our certified electrician for today between two and five PM at 812 Highland View. Our electrician will text you fifteen minutes before arrival. I just sent confirmation to your mobile — anything else I can help with?",
            ...
            "daytime_agent_service": f"Yes, definitely — that is something our licensed electricians deal with every day. A main breaker tripping repeatedly usually points to an overloaded circuit, a short, or a failing breaker switch. Are you noticing any burning smell, buzzing, or heat coming from the panel?",
            ...
            "daytime_agent_price_a": f"We don't do blind hourly surprises — {pricing_spoken} Our electrician conducts a full electrical safety check, load calculation, and circuit tracing, and gives you a transparent upfront quote before doing any repair.",
            "daytime_cust_area_q": f"That sounds honest. I'm over at 812 Highland View in {city_disp} — can you get an electrician out to {city_disp} this afternoon?",
            "daytime_agent_area_a": f"Yes, Highland View in {city_disp} is right in our primary coverage zone. We have certified electricians in {city_disp} between two and five PM. May I have your name and best phone number?",
            "daytime_cust_name_turn": "Robert Davis, mobile is 404-555-0177. If my breaker panel turns out to be old and needs a full 200-amp upgrade, do you do panel replacements too?",
            "daytime_agent_scope_a": f"Yes! We specialize in " + (f"{custom_services_str}, " if custom_services_str else "") + "full 200-amp panel upgrades, whole-home rewiring, EV chargers, and surge protection. We handle all permits and city inspections from start to finish.",
            ...
            "ah_booking_line": f"Perfect — I've reserved our first-priority slot tomorrow morning at eight AM for 1042 Bayside Avenue. Our master electrician has your panel notes and will text before arrival. I just sent confirmation to your cell.",
            ...
            "ah_agent_solution": f"Please do NOT touch the warm breaker or force it. If you can safely turn off that individual switch without touching metal, do so, otherwise leave the panel door closed. I am reserving our first-priority emergency slot tomorrow at eight AM, and alerting our on-call master electrician right now. {pricing_spoken}",
            ...
            "ah_agent_scope_a": "That's why our 24/7 line exists, Marcus. You did the right thing calling — we will make sure your home is 100% safe first thing.",
        },
        "roofing": {
            "title": "Storm Damage & Roof Leak Inspection",
            ...
            "booking_confirm_line": f"You're all set, Tom! I've scheduled our senior roofing estimator for today between one and four PM at 518 Pine Valley Road for your complimentary 21-point roof inspection. Our estimator will text fifteen minutes before arrival. I just sent confirmation to your mobile — anything else I can help with?",
            "sms_body_routine": f"Hi Tom! You're confirmed with {biz_name} for today, 1–4 PM at 518 Pine Valley Road for your complimentary 21-point roof inspection. Our estimator will text 15 min before arrival. Reply anytime.",
            "daytime_cust_problem": "Hi! We had severe wind and hail yesterday, and this morning I found a patch of shingles in my yard and a brownish water ring on my upstairs ceiling. Do you do roof inspections?",
            "daytime_agent_service": f"Yes, absolutely — that is right in our wheelhouse. Missing shingles and a ceiling water ring after a storm mean water has penetrated the underlayment, so getting a certified inspector out quickly before the next rainfall is critical. Are you home today so we can inspect it?",
            "daytime_cust_price_q": "Yes I'm working from home. What do you charge just to come inspect the roof and take photos?",
            "daytime_agent_price_a": f"Good news — {pricing_spoken} Our comprehensive 21-point roof inspection is 100% complimentary. We inspect shingles, flashing, decking, gutters, and check your attic space for hidden moisture, and provide a full photo report with zero obligation.",
            "daytime_cust_area_q": f"Wow, free inspection with photos? I'm at 518 Pine Valley Road in {city_disp} — is that within your inspection zone?",
            "daytime_agent_area_a": f"Yes, Pine Valley Road in {city_disp} is right in our primary service area. We have an inspector scheduled in {city_disp} between one and four PM today. May I get your name and best mobile number?",
            "daytime_cust_name_turn": "Tom Reynolds, mobile is 303-555-0162. One question — if it requires an insurance claim for hail damage, do you work with insurance adjusters directly?",
            "daytime_agent_scope_a": f"Yes, we work directly with all major insurance companies. We specialize in " + (f"{custom_services_str}, " if custom_services_str else "") + "spot leak repairs, drone inspections, and full roof replacements.",
            "ah_slot": "Tomorrow 7:30 AM First Light Storm Response",
            "ah_status": "Storm Damage Triage — Crew Alerted for 7:30 AM",
            "owner_alert_ah_title": "🌙 After-Hours Roof Leak Emergency Dispatched",
            "ah_booking_line": f"Perfect — I've locked in our emergency storm crew for first light tomorrow at seven-thirty AM at 1042 Bayside Avenue to get tarps up and stop the water. I just texted confirmation to your cell.",
            ...
            "ah_cust_problem": "Hello? It's pouring rain outside at midnight and water is actively dripping through my upstairs bedroom ceiling into a bowl. What can I do right now?",
            "ah_agent_triage": "I'm so sorry you're dealing with that during a storm. First, is the water dripping near any ceiling light fixtures or electrical switches?",
            ...
            "ah_agent_solution": f"Keep that bucket in place, and if the ceiling starts sagging, poke a tiny pinhole in the center to relieve pressure. I am locking you in for our very first seven-thirty AM emergency storm response slot so our crew can get emergency tarps up the moment daylight breaks. {pricing_spoken}",
            "ah_cust_address_q": "Thank you so much. I'm at 1042 Bayside Avenue — can you definitely get someone out at first light?",
            "ah_agent_address_a": f"Yes, Bayside Avenue in {city_disp} will be our first emergency stop. Can I get your full name and mobile number to dispatch the storm crew alert?",
            "ah_cust_info_turn": "Marcus Vance, cell is 415-555-0834. And you guys do emergency tarping and insurance documentation?",
            "ah_agent_scope_a": "Yes, our storm trucks carry heavy-duty tarps and safety harnesses, and we document everything for your insurer.",
        },
        "dental_medical": {
            ...
            "booking_confirm_line": f"You're all set, Emily! I've reserved our emergency doctor chair for you today at one-thirty PM at {biz_name}. Please arrive ten minutes early for check-in. I just texted your confirmation and digital intake link to your cell — anything else I can help with?",
            ...
            "daytime_agent_service": f"I am so sorry you are dealing with that pain — severe toothaches are completely miserable. We always reserve same-day emergency chairs specifically for acute dental pain and urgent evaluations. Are you noticing any facial swelling or fever along with the sensitivity?",
            ...
            "daytime_agent_price_a": f"We accept all major PPO dental insurances like Delta Dental, MetLife, Cigna, and Guardian, which usually cover emergency diagnostics. For self-pay patients, {pricing_spoken} It includes digital X-rays and a gentle doctor evaluation with upfront pricing before any treatment.",
            ...
            "daytime_agent_area_a": f"Our clinic is centrally located in {city_disp} with convenient dedicated patient parking. We have an open emergency chair today at one-thirty PM. Can I get your full name and cell number so our clinical coordinator can prepare your chart?",
            "daytime_cust_name_turn": "Emily Watson, cell is 214-555-0145. If the tooth needs a root canal or crown, do you do that in-house or refer me out to an endodontist?",
            "daytime_agent_scope_a": f"Our doctors perform " + (f"{custom_services_str}, " if custom_services_str else "") + "root canals, tooth-colored crowns, extractions, and fillings right here in our office under one roof, and we offer gentle sedation so you are completely comfortable.",
            ...
            "ah_booking_line": f"Perfect — I've reserved our very first emergency chair tomorrow morning at eight AM at {biz_name}. Our clinical team will have your chart ready when doors open. I just texted your confirmation and digital intake link.",
            ...
            "ah_agent_triage": "Ouch, an exposed nerve is terribly painful. Let's make sure you're safe: are you having any continuous bleeding, or trouble breathing or swallowing?",
            "ah_cust_clarify": "No bleeding, just intense sensitivity when air hits it. Can I take ibuprofen?",
            "ah_agent_solution": f"Yes, you can take over-the-counter ibuprofen with water, and if you have orthodontic wax or clean sugar-free gum, you can gently cover the sharp edge tonight. I am reserving our very first eight AM emergency chair tomorrow morning so our doctor can treat that tooth first thing. {pricing_spoken}",
            "ah_cust_address_q": "That would be a lifesaver. Will the doctor be there right at eight?",
            "ah_agent_address_a": "Yes, our clinical team opens at seven-forty-five and our doctor will see you first thing at eight. Can I get your full name and best cell number?",
            "ah_cust_info_turn": "Marcus Vance, cell is 415-555-0834. Do I need to bring my insurance card?",
            "ah_agent_scope_a": "Yes, bring your dental insurance card and photo ID. I just texted you our instant digital intake link so you can complete your medical history from your phone tonight.",
        },
        "auto": {
            ...
            "booking_confirm_line": f"You're all set, Chris! I've reserved our diagnostic inspection bay for you today at one o'clock at {biz_name}. You can pull right up to Bay 1, and our service advisor will check you in. I just texted your work order confirmation to your mobile — anything else I can help with?",
            ...
            "daytime_agent_service": f"Yes, absolutely — we can get that on the lift for you today. A flashing check engine light combined with severe brake vibration means it needs immediate diagnostic attention. Can you safely nurse the car into our shop, or would you prefer a tow truck?",
            ...
            "daytime_agent_price_a": f"Dealership pricing can be frustrating — {pricing_spoken} Our diagnostic scan includes reading all OBD2 computer codes, micrometer rotor measurements, suspension inspection, and a digital health report texted to your phone before any work begins.",
            "daytime_cust_area_q": f"Where is your shop located in {city_disp}, and can I drop it off around one o'clock?",
            "daytime_agent_area_a": f"Our shop is located centrally in {city_disp} with easy customer drop-off lanes. Yes, one o'clock is perfect — our service advisor will have your work order ready. May I get your name and cell number?",
            "daytime_cust_name_turn": "Chris Martinez, cell is 615-555-0133. It's a 2018 Honda Accord. Do you guys do full transmission and engine repairs too if it's more than just brakes?",
            "daytime_agent_scope_a": f"Yes, we handle " + (f"{custom_services_str}, " if custom_services_str else "") + "complete engine diagnostics, transmission repairs, suspension, brakes, and factory maintenance bumper-to-bumper with warranty on all parts and labor.",
            ...
            "ah_booking_line": f"Perfect — you can have the tow truck drop your car in our secure lot tonight and put your keys in our overnight drop box by bay door number one. Our master mechanic will pull it in at eight AM tomorrow. I just texted you our shop address and drop box instructions.",
            ...
            "ah_agent_solution": f"Perfect — you can have your tow truck drop the vehicle directly into our secure fenced lot tonight. We have a secure twenty-four-seven night key drop box right by bay door number one. Our master technician will pull it onto the diagnostic rack first thing at eight AM. {pricing_spoken}",
            "ah_cust_address_q": "Can you text me your exact shop address and key drop instructions?",
            "ah_agent_address_a": "Absolutely. I'm texting you our direct shop address and key drop envelope instructions right now. Can I get your name and vehicle make?",
            "ah_cust_info_turn": "Marcus Vance, 415-555-0834, it's a 2019 Toyota Camry.",
            "ah_agent_scope_a": "Got it, Marcus. Your Camry will be first in line when our techs clock in at eight AM. We will call you with the digital inspection report before touching a thing.",
        },
        "legal": {
            ...
            "booking_confirm_line": f"You're all set, Amanda! I've confirmed your confidential legal consultation for today at two PM with our senior attorney. We will connect via phone directly at this number. Our intake team will send your secure intake paperwork right now. I just texted confirmation to your cell — anything else I can help with?",
            ...
            "daytime_agent_service": f"First, I am so sorry you experienced that — dealing with aggressive insurance adjusters while recovering from an accident is exhausting. You should definitely not sign anything or give recorded statements until an attorney reviews your file. Are you currently receiving medical care for your injuries?",
            ...
            "daytime_agent_price_a": f"You don't need to worry about money at all — {pricing_spoken} Our firm works on a contingency fee basis, which means you pay zero out of pocket, and zero fees unless our attorneys successfully recover compensation for you.",
            ...
            "daytime_agent_area_a": f"Yes, absolutely! We serve clients across the entire {city_disp} area via phone, secure video, or in-person at our office. We have an opening today at two PM with one of our senior attorneys. Can I have your full name and best number?",
            "daytime_cust_name_turn": "Amanda Jenkins, cell is 312-555-0155. Will your firm handle my medical bills and dealing with the insurance company directly?",
            "daytime_agent_scope_a": f"Yes, our legal team takes over all communication with insurance adjusters, specializes in " + (f"{custom_services_str}, " if custom_services_str else "") + "accident injury claims, hospital liens, and fights for your full compensation so you can focus 100% on healing.",
            ...
            "ah_booking_line": f"I have logged Marcus Vance into our priority intake queue, and alerted our on-call criminal defense counsel. An attorney will review his booking docket and call you tomorrow morning at eight AM before his arraignment hearing. I just texted confirmation to your mobile.",
            ...
            "ah_agent_solution": f"Understood. Advise him not to answer questions or discuss the incident until his attorney is present. I am alerting our on-call criminal defense counsel right now with his booking details, and scheduling a priority morning case review at eight AM before his arraignment hearing. {pricing_spoken}",
            "ah_cust_address_q": "Can someone definitely review his case before the morning hearing?",
            "ah_agent_address_a": "Yes, our on-call legal counsel handles morning arraignments regularly. Can I get his full legal name, date of birth, and your mobile number?",
            "ah_cust_info_turn": "Marcus Vance is his name, and my cell is 415-555-0834.",
            "ah_agent_scope_a": "I have logged Marcus Vance into our priority intake queue. I'm texting you a confirmation and our counsel will review his docket first thing in the morning.",
        },
        "restaurant": {
            ...
            "booking_confirm_line": f"You're all set, Jessica! I have reserved a wonderful table for six guests this Friday at seven-fifteen PM at {biz_name}, with complimentary champagne flutes and our chef's allergen notes flagged. I just texted your confirmation and dining details to your phone — anything else I can help with?",
            ...
            "daytime_agent_service": f"Happy 40th anniversary to your parents — forty years is such a wonderful milestone! We would love to host your family celebration. We have a great table available in our main dining room this Friday at seven-fifteen PM. Would that time work well for your group?",
            ...
            "daytime_agent_price_a": "There is zero reservation fee or deposit for parties of six. Our dining room dress code is smart casual, and we offer complimentary valet parking right at our main entrance.",
            ...
            "daytime_agent_area_a": f"Yes, our executive chef takes allergies very seriously. We welcome guests from {city_disp} and across the region, and we have dedicated gluten-free preparation cookware. We note all severe allergies directly on your kitchen ticket before you even sit down. Can I get your name and cell number for the reservation?",
            ...
            "daytime_agent_scope_a": "Absolutely! I have added a celebratory note for complimentary champagne flutes upon arrival and our chef's signature anniversary dessert. We also do private dining buyouts and custom catering menus for future events.",
            ...
            "ah_booking_line": f"I have flagged your corporate event for eighteen guests directly for our General Manager and Event Director for first-thing morning review. Our Event Director will call you at eight-thirty AM tomorrow to confirm the private wine room and custom menu. I just sent an SMS receipt to your mobile.",
            ...
            "ah_agent_solution": f"Our private wine room comfortably seats up to twenty-two guests. I am flagging your event parameters directly for our General Manager and Event Director with urgent priority for an eight-thirty AM morning callback to confirm the preset menu and wine selections.",
            "ah_cust_address_q": "Can you text me confirmation that this inquiry was received by management?",
            "ah_agent_address_a": "Yes! I am sending an instant SMS receipt right now so you know your reservation request is logged first in line for morning review.",
        ...
        "realestate": {
            ...
            "booking_confirm_line": f"You're all set, Brandon! I have locked in your private showing for today at four-thirty PM at 842 Highland Park Boulevard. Our licensed agent will meet you at the front entrance with all property disclosures. I just texted your appointment confirmation to your cell — anything else I can help with?",
            ...
            "daytime_agent_service": f"Hello! Yes, the home on Highland Park Boulevard is actively on the market — it's a gorgeous property with high ceilings and an updated chef's kitchen. We can certainly coordinate a private walkthrough for you this afternoon. Are you pre-approved with a lender or looking to purchase with cash?",
            ...
            "daytime_agent_price_a": f"Good news — {pricing_spoken} Our dedicated buyer representation is 100% complimentary to you because the seller covers all broker commissions upon closing. You get our full contract drafting, MLS access, and negotiation expertise with zero out-of-pocket agent fees.",
            ...
            "daytime_agent_area_a": f"Yes, absolutely! {city_disp.title()} is our primary market — our licensed agents live and work in {city_disp} every day. We actually have an open private lockbox showing window this afternoon at four-thirty PM. May I get your full name and cell number for the property access confirmation?",
            "daytime_cust_name_turn": "Brandon Cole, cell is 206-555-0182. If we love the house, do you help us draft the purchase offer and negotiate inspection repairs?",
            "daytime_agent_scope_a": "Yes, our licensed agents guide you through the entire process — drafting competitive purchase offers with protective escalation clauses, negotiating repair credits, reviewing HOA disclosures, and guiding you all the way through closing.",
            ...
            "ah_booking_line": f"I've logged your four-bedroom listing inquiry and alerted our managing broker to prepare a complimentary market analysis tonight. Our broker will meet you on-site at 1042 Bayside Avenue tomorrow morning at nine AM with recent neighborhood comps. I just sent confirmation to your mobile.",
            ...
            "ah_agent_solution": f"Bayside Avenue is a high-demand luxury market. I am alerting our senior managing broker right now with your home details to prepare a complimentary Comparative Market Analysis and staging proposal, and scheduling a priority nine AM consultation tomorrow morning. {pricing_spoken}",
            "ah_cust_address_q": "Can the broker come out to the property tomorrow morning?",
            "ah_agent_address_a": f"Yes, our managing broker can meet you on-site tomorrow morning at nine AM with recent neighborhood comps in hand. Can I get your full name and best cell number?",
            "ah_cust_info_turn": "Marcus Vance, cell is 415-555-0834, address is 1042 Bayside Avenue.",
            "ah_agent_scope_a": "I've locked in Marcus Vance for 1042 Bayside Avenue. Our broker will have professional photography, drone footage, and staging plans ready for your morning meeting.",
        },
        "salon_spa": {
            ...
            "booking_confirm_line": f"You're all set, Ashley! I have reserved our master colorist for you this Thursday at two PM at {biz_name} for your custom balayage, toner, and blowout. Please arrive five minutes early to relax. I just texted your styling appointment confirmation to your mobile — anything else I can help with?",
            ...
            "daytime_agent_service": f"Hello! We would love to take care of you and have you looking gorgeous for the wedding! We have an opening with one of our master colorists this Thursday at two PM. How long is your hair right now, and is it currently color-treated?",
            ...
            "daytime_agent_price_a": "We believe in 100% transparent pricing — a full custom balayage, toner, and signature blowout for shoulder-length hair ranges between one hundred eighty and two hundred ten dollars, including our Olaplex bonding treatment with zero hidden fees.",
            "daytime_cust_area_q": "That's very fair! Where is your salon located, and is parking easy?",
            "daytime_agent_area_a": f"Our salon is centrally located in {city_disp} in a boutique plaza with complimentary dedicated customer parking right out front. Can I get your full name and mobile number to hold that Thursday two PM chair?",
            ...
            "daytime_agent_scope_a": "Yes! We offer lash lifts, brow lamination, custom facials, and special event makeup in our spa suites. You can easily bundle beauty services all in one visit.",
            ...
            "ah_booking_line": f"I have logged your bridal party timeline adjustment directly for our Bridal Coordinator and Lead Stylist for first-thing morning review. Our coordinator will text and call you by eight-thirty AM to ensure all chairs are shifted earlier. I just sent an SMS receipt to your mobile.",
            ...
            "ah_agent_triage": "Bridal mornings can be hectic — don't panic! We manage wedding party timelines all the time. What time does the bridal party need to be finished by on Saturday?",
            "ah_cust_clarify": "The photographer arrives at eleven-thirty AM, so we need all hair and makeup completed by eleven AM sharp.",
            "ah_agent_solution": "I am logging your timeline adjustment directly for our Bridal Coordinator and Lead Stylist for first-thing eight AM morning review to shift your chairs earlier so everyone is photo-ready before eleven AM. I'm texting you a receipt right now.",
        ...
        "general": {
            ...
            "booking_confirm_line": f"You're all set, Mark! I've scheduled our commercial service specialist for today between one and four PM at 419 Commercial Boulevard. Our specialist will text you fifteen minutes before arrival with an upfront written scope. I just sent confirmation to your mobile — anything else I can help with?",
            ...
            "daytime_agent_service": f"Yes, absolutely — we can send a service specialist out to your facility today to inspect the issue and provide a clear written estimate. What specific equipment or area of the property is malfunctioning?",
            ...
            "daytime_agent_price_a": f"We provide upfront, transparent flat-rate pricing — {pricing_spoken} Our specialist conducts a complete on-site inspection and provides a written estimate before any work starts.",
            "daytime_cust_area_q": f"We are located at 419 Commercial Boulevard in {city_disp} — can you have a specialist out here this afternoon?",
            "daytime_agent_area_a": f"Yes, 419 Commercial Boulevard in {city_disp} is within our primary service coverage. We have an opening today between one and four PM. May I have your name and best mobile number?",
            "daytime_cust_name_turn": "Mark Stevenson, mobile is 555-234-5678. Do you also provide annual preventative maintenance contracts for commercial facilities?",
            "daytime_agent_scope_a": "Yes, we provide routine scheduled maintenance contracts, emergency rapid response, and full equipment replacements. We tailor service agreements specifically to your facility.",
            ...
            "ah_booking_line": f"Understood — I've reserved our very first priority slot tomorrow morning at eight AM for 1042 Bayside Avenue, and alerted our on-call supervisor right now. Our specialist will text when en route in the morning. I just texted confirmation to your cell.",
    ...
    if is_text_details_booking:
        ah_booking_line = (
            f"I've got your info — 1042 Bayside Avenue, Marcus Vance, and I'm alerting our on-call team right now. "
            f"Someone will reach out first thing in the morning to get you taken care of. "
            f"I'm texting you a confirmation as well so you have it in writing."
        )
    ...
    all_scenarios: Dict[str, Dict[str, Any]] = {
        "routine_booking": {
            ...
            "scenario_desc": (
                f"{persona_name} picks up on the first ring, handles every hard question — "
                "hours, territory, scope, pricing — then secures the booking without missing a beat."
            ),
            ...
            "turns": [
                ...
                },
                {
                    ...
                    "name": f"{persona_name} (Receptionist)",
                    "voice": persona_voice,
                    "text": f"{tdata['daytime_agent_scope_a']} {booking_confirm_line}"
                },
                {
                    "speaker": "customer",
                    "name": tdata["caller_name"],
                    "voice": customer_voice,
                    "text": "Wow, okay — I wasn't expecting it to be that easy honestly. I've been putting this off because I thought it would be a whole ordeal. Thank you so much."
                },
                {
                    "speaker": "agent",
                    "name": f"{persona_name} (Receptionist)",
                    "voice": persona_voice,
                    "text": f"That's exactly what we're here for! Have a wonderful day, and we'll talk soon!"
                },
            ],
            "outcome": {
        ...
        "after_hours_test": {
            ...
            "scenario_desc": (
                f"{persona_name} answers at 11:45 PM, instantly detects after-hours mode, "
                "triages emergency urgency, handles pricing & availability, "
                "and secures the morning slot — all without waking the owner."
            ),
            ...
            "turns": [
                ...
                },
                {
                    ...
                    "name": f"{persona_name} (Receptionist)",
                    "voice": persona_voice,
                    "text": f"{tdata['ah_agent_scope_a']} {ah_booking_line}"
                },
                {
                    "speaker": "customer",
                    "name": "Marcus (Caller)",
                    "voice": customer_voice,
                    "text": "Honestly I did not expect to reach a real person at midnight, let alone get everything handled. I really appreciate it — seriously."
                },
                {
                    "speaker": "agent",
                    "name": f"{persona_name} (Receptionist)",
                    "voice": persona_voice,
                    "text": f"That's exactly why we're here, Marcus — so you never have to worry or be left hanging. You're all set, and we'll take care of you in the morning!"
                },
            ],
            "outcome": {
                ...
                "sms_preview": {
                    ...
                    "sender_label": f"{biz_name} After-Hours Dispatch",
                    "message_body": sms_body_ah,
                },
                "owner_dispatch": {
                    "title": owner_alert_ah_title,
                    "details": f"Marcus Vance • 1042 Bayside Avenue • Late-Night Breakdown • {pricing}",
                    "phone": owner_phone_display,
                },
            },
        },
